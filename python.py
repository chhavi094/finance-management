...
openai.api_key = 'sk-proj-ilph1nE2DjdusExWK6vvT3BlbkFJdqary4g2JmuqW9k0ZH8L'



# Configure database connection
app.config['MYSQL_HOST'] = 'database-1.c3y0qweqgoh6.ap-south-1.rds.amazonaws.com'
app.config['MYSQL_USER'] = 'admin'
app.config['MYSQL_PASSWORD'] = 'saishravan45'
app.config['MYSQL_DB'] = 'finance_manager'
